...
SECRET_TEXT = "integration optin freeze secret"


def test_v34_runtime_optin_hook_freeze_manifest_and_boundaries() -> None:
    ...
    try:
        ...
        request = {"caller": "translation_runtime", "runtime_id": "integration-freeze-345", "text": SECRET_TEXT}
