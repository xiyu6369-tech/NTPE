...
|---|---|---:|---|---|
| Smoke_Set | True | 78.0 | warning | plot_fidelity_proxy: very short translation ratio=0.09; natural_chinese_proxy: korean_hits=0, chinese_density=0.81; subject_pronoun_proxy: demonstrative_repetition=0; character_voice_dialogue_proxy: no dialogue in source; format_punctuation: simplified_hints=0 |
...
|---|---:|---:|---|---|
| plot_fidelity_proxy | 8.0 | 30.0 | FAIL | very short translation ratio=0.09 |
