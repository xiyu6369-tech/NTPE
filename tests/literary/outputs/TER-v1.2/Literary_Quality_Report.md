# NTPE Literary Quality Report — TER-v1.2

- Status: success
- Overall Score: 100.0/100
- Previous Stage: `TER-v1.1`

| Test Set | Exists | Score | Status | Key Notes |
|---|---|---:|---|---|
| Smoke_Set | True | 100.0 | success | plot_fidelity_proxy: length ratio=0.72; natural_chinese_proxy: korean_hits=0, chinese_density=0.85; subject_pronoun_proxy: demonstrative_repetition=0; character_voice_dialogue_proxy: no dialogue in source; format_punctuation: simplified_hints=0 |
...
|---|---:|---:|---|---|
| plot_fidelity_proxy | 30.0 | 30.0 | PASS | length ratio=0.72 |
