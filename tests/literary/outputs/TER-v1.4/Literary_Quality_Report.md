# NTPE Literary Quality Report — TER-v1.4
...
|---|---|---:|---|---|
| Smoke_Set | True | 100.0 | success | plot_fidelity_proxy: length ratio=0.67; natural_chinese_proxy: korean_hits=0, chinese_density=0.85; subject_pronoun_proxy: demonstrative_repetition=0; character_voice_dialogue_proxy: no dialogue in source; format_punctuation: simplified_hints=0 |
...
|---|---:|---:|---|---|
| plot_fidelity_proxy | 30.0 | 30.0 | PASS | length ratio=0.67 |
| locked_names_terms | 20.0 | 20.0 | PASS | ok |
| natural_chinese_proxy | 20.0 | 20.0 | PASS | korean_hits=0, chinese_density=0.85 |
