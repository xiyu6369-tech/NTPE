...
ISSUE_DISCIPLINE_MAPPING = {
    "CHARACTER_VOICE_DRIFT": "PRESERVE_PARAGRAPH_INTENT",
    "HONORIFIC_REGISTER_DRIFT": "PRESERVE_PARAGRAPH_INTENT",
    "RELATIONSHIP_DISTANCE_DRIFT": "PRESERVE_PARAGRAPH_INTENT",
    "NARRATIVE_VIEWPOINT_DRIFT": "PRESERVE_PARAGRAPH_INTENT",
    "NARRATIVE_REGISTER_DRIFT": "PRESERVE_PARAGRAPH_INTENT",
    "ERA_INAPPROPRIATE_EXPRESSION": "PRESERVE_PARAGRAPH_INTENT",
    "DIALOGUE_NARRATION_REGISTER_MIX": "PRESERVE_PARAGRAPH_INTENT",
