...
def build_registry() -> CommandRegistry:
    ...
    try:
        ...
        pass
    try:
        from .commands.quality import register_quality_command
        register_quality_command(registry)
    except Exception:
        # Keep CLI core usable even if optional command modules are unavailable.
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        from .commands.plugin import register_plugin_command
        register_plugin_command(registry)
    except Exception:
        # Keep CLI core usable even if optional command modules are unavailable.
        pass
    return registry
