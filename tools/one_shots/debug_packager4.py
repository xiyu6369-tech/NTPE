...
from core.epub_translation.runtime.epub_packager import EpubPackagingInput, pack_epub_resource_aware, _validate_epub_archive
...
with tempfile.TemporaryDirectory() as tmp:
    ...
    # First, test the packager without validation
    from core.epub_translation.runtime.epub_packager import _validate_epub_archive
    original_validate = _validate_epub_archive
    
    def debug_validate(path):
        print(f"Validating: {path}")
        try:
            errors = original_validate(path)
    ...
    packager_module._validate_epub_archive = debug_validate
