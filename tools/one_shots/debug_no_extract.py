...
with tempfile.TemporaryDirectory() as tmp:
    ...
    # Also disable resource extraction to see if that's the issue
    original_extract = packager_module._extract_epub_resources
    packager_module._extract_epub_resources = lambda path: packager_module.ExtractedEpubResources(
        manifest_items=(),
