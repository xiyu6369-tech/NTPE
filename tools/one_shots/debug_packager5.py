...
with tempfile.TemporaryDirectory() as tmp:
    ...
    # Test validation on the SOURCE epub first
    print("=== Testing validation on SOURCE epub ===")
    try:
        errors = _validate_epub_archive(source_epub)
        print(f"Source validation errors: {errors}")
    except Exception as e:
        print(f"Source validation exception: {e}")
        traceback.print_exc()
    
    # Now test the packager
