#!/usr/bin/env python3
"""Quick S1 test to verify API and basic functionality."""
...
print("\nTest 4: Continuity with glossary")
continuity = '김철수는 30년 경력의 형사였다. 그가 맡은 사건은 언제나 복잡했지만, 그는 특유의 직관으로 진실을 파헤쳐왔다. 그의 파트너 이영희는 그와 정반대였다. 논리와 증거만으로 사건을 풀어나가는 원칙주의자였다.'
